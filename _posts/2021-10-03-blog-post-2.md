...
Do you know how to compute the projection onto structured convex sets, and how to use them to solve constrained optimization problems? Find out more in this post.
