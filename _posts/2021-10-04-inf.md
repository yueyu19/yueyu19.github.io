...
If I give you an optimization problem with thousands of constraints, can you tell me whether the problem has a solution at all? We propose a new method to answer this question that, for the first time, avoids expensive matrix inverse computation. Find out more in this post and [our new paper](https://arxiv.org/pdf/2109.02756.pdf)! 
