...
Finally, by summing up equation (8-13), and letting $\alpha=\frac{1}{\lambda}$, we obtain the following result:
  ...
  $$\frac{1+\frac{\mu}{\lambda}}{2}||x^{k+1}-x^\star||\leq \frac{1-\frac{\mu}{\lambda}}{2}||x^k-x^\star||^2.$$
...
======
  ...
  If you like the above convergence proof and its connection to the law of cosines, there are many other proofs just like it in my [PhD dissertation](https://digital.lib.washington.edu/researchworks/bitstream/handle/1773/46999/Yu_washington_0250E_22557.pdf?sequence=1&isAllowed=y). In its Appendix B, I rewrote the convergence proofs of most existing first order methods using the law of cosines. I also use the law of cosines in many of my published papers on optimization algorithms, see my [list of publications] 
