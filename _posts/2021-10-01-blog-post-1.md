...
Finally, by summing up equation (8-13), and letting $0<\alpha\leq\frac{1}{\lambda}$, we obtain the following result:
...
======
  ...
  Now that you have the skeleton key to unlock all of these proofs, and many more out there. As Professor Slughorn said to Harry potter: <em>Use it well!<em>
